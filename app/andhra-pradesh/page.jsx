...
export const metadata = {
  title: "Andhra Pradesh Tour Packages - Land of Temples",
  description:
    "Explore Andhra Pradesh with our curated tour packages. Tirupati, Ahobilam, Srikalahasti and more.",
};
...
export default function AndhraPradeshPage() {
  ...
  const related = destinations
    .filter((d) => d.region === "domestic" && d.slug !== "andhra-pradesh")
    .slice(0, 3);
