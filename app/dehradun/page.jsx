...
export const metadata = {
  title: "Dehradun Tour Packages - Doon Valley",
  description:
    "Explore Dehradun with our curated tour packages. Robber's Cave, Sahastradhara, Mussoorie and Himalayan views.",
};

export default function DehradunPage() {
  const dest = getDestination("dehradun");

  const related = destinations
    .filter((d) => d.region === "domestic" && d.slug !== "dehradun")
    .slice(0, 3);
