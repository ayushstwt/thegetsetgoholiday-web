...
export const metadata = {
  title: "Nainital Tour Packages - The Lake District",
  description:
    "Explore Nainital with our curated tour packages. Naini Lake, Mall Road, Snow View Point and Himalayan getaways.",
};

export default function NainitalPage() {
  const dest = getDestination("nainital");

  const related = destinations
    .filter((d) => d.region === "domestic" && d.slug !== "nainital")
    .slice(0, 3);
