...
export const metadata = {
  title: "Darjeeling Tour Packages - The Queen of Hills",
  description:
    "Explore Darjeeling with our curated tour packages. Tea gardens, toy train rides, Tiger Hill sunrise and Himalayan views.",
};

export default function DarjeelingPage() {
  const dest = getDestination("darjeeling");

  const related = destinations
    .filter((d) => d.region === "domestic" && d.slug !== "darjeeling")
    .slice(0, 3);
