...
export const metadata = {
  title: "Haridwar Tour Packages - Gateway to God",
  description:
    "Explore Haridwar with our curated tour packages. Ganga Aarti, temple tours and spiritual getaways.",
};

export default function HaridwarPage() {
  const dest = getDestination("haridwar");

  const related = destinations
    .filter((d) => d.region === "domestic" && d.slug !== "haridwar")
    .slice(0, 3);
