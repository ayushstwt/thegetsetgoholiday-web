...
const highlights = [
  "Witness the breathtaking sunrise over Kanchenjunga from Tiger Hill",
  "Ride the UNESCO-listed Darjeeling Himalayan Toy Train",
  "Explore sprawling tea gardens with fresh brew tasting",
  "Visit ancient Buddhist monasteries and Peace Pagoda",
  "Stroll the colonial Mall Road and Chowrasta",
  "Experience the scenic Batasia Loop and War Memorial",
];

const galleryImages = getDestination("darjeeling")?.gallery || [];

export default function DarjeelingSection() {
  return (
    <div className="mt-14 reveal">
      <div className="mb-12 text-center">
        <span className="section-eyebrow">Darjeeling · Queen of Hills</span>
        <h2 className="section-title">Discover the Magic of Darjeeling 🚂</h2>
        <p className="mx-auto mt-3 max-w-2xl text-slate-600 dark:text-slate-300">
          Nestled in the Himalayan foothills, Darjeeling enchants with its
          emerald tea gardens, charming toy train and panoramic mountain views.
        </p>
      </div>
      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="overflow-hidden rounded-2xl bg-white shadow-lg ring-1 ring-black/5 transition duration-300 hover:shadow-2xl dark:bg-slate-800">
          <div className="relative h-56 w-full sm:h-60">
            <Image
              src="/darjeeling/2.jpg"
              alt="Scenic view of Darjeeling"
              fill
              loading="lazy"
              sizes="100vw"
              className="object-cover"
      ...
      <section className="mt-16">
        <div className="mb-8 text-center">
          ...
          <h2 className="section-title">Capturing the Beauty of Darjeeling</h2>
          <p className="mx-auto mt-3 max-w-2xl text-slate-600 dark:text-slate-300">
            A visual journey through misty tea gardens, winding toy train tracks and
            the majestic Himalayas.
          </p>
        </div>
        <div className="px-4 sm:px-6 lg:px-8">
          <ImageGallery images={galleryImages} name="Darjeeling" />
        </div>
      </section>
    </div>
  );
